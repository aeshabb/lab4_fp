(** Юнит-тесты для базовой библиотеки парсер-комбинаторов *)

open Alcotest
open Parser_combinator.Parser

(** {1 Вспомогательные функции для тестирования} *)
